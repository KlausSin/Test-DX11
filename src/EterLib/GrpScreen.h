...
public:
	...
	void RenderBar3d(const XMFLOAT3* c_pv3Positions);
	...
	void RenderCube(float sx, float sy, float sz, float ex, float ey, float ez, XMFLOAT4X4 matRotation);
	...
	void RenderBillboard(XMFLOAT3* Position, XMFLOAT4& Color);
	...
	void SetOneColorOperation(XMFLOAT4& rColor);
	void SetAddColorOperation(XMFLOAT4& rColor);
