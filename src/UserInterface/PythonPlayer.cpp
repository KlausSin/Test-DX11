...
const uint64_t POINT_MAGIC_NUMBER = 0xe73ac1dae73ac1daULL;
...
void CPythonPlayer::NEW_ShowEffect(int dwEID, TPixelPosition kPPosDst)
{
	...
	XMFLOAT3 kD3DVt3Pos(kPPosDst.x, -kPPosDst.y, kPPosDst.z);
	XMFLOAT3 kD3DVt3Dir(0.0f, 0.0f, 1.0f);
...
void CPythonPlayer::AlarmHaveToGo()
{
	...
	XMFLOAT3 v3Rotation(0.0f, 0.0f, fAngle);
