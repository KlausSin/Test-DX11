...
class CMapOutdoor : public CMapBase
{
	...
	protected:
		...
		IBufferPtr					m_IndexBuffer[TERRAINPATCH_LODMAX];
	...
	protected:
		...
		//////////////////////////////////////////////////////////////////////////
		// Character Shadow
		ID3D11Texture2D*			m_lpCharacterShadowMapTex;
		ID3D11ShaderResourceView*	m_lpCharacterShadowMapTexture;
		ID3D11RenderTargetView*		m_lpCharacterShadowMapRTV;
		ID3D11Texture2D*			m_lpCharacterShadowMapDepthTex;
		ID3D11DepthStencilView*		m_lpCharacterShadowMapDSV;
		D3D11_VIEWPORT				m_ShadowMapViewport;
		WORD					m_wShadowMapSize;

		// Backup Device Context
		ID3D11RenderTargetView*	m_lpBackupRTV;
		ID3D11DepthStencilView*	m_lpBackupDSV;
		D3D11_VIEWPORT			m_BackupViewport;
		UINT					m_uBackupNumViewports;
